...
var poslajutracking = function () {
    ...
    var parseTrackingID = function (idx, calltype, app, callbackFn) {
        ...
        // Get the skey puih!
        request("http://www.poslaju.com.my/track-trace/", function (error, response, body) {
            var skey = body.match(/(:"[\w]+")/)[1];
            var trimmedSkey = skey.substring(2, skey.length - 1);
            
            //var url = "http://www.pos.com.my/emstrack/viewdetail.asp?parcelno=" + idx;
            var url = "http://api.pos.com.my/v2TrackNTraceWebApi/api/Details/" + idx + "?callback=results&sKey=" + trimmedSkey + "&_=1447777939607";
